...
?>  
    ...
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" 
                id="form"
                action="<?php echo site_url("payroll/incentive/report");?>" >
            ...
            <div id="divToPrint">
                ...
                <div class="item_body">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h3>Puja Incentive among the Contingent labours etc, during the year <?php echo $incentive_year->param_value;?></h3>
