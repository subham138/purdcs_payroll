   ...
   <div class="main-panel">
               ...
               <div class="card-body">
                   ...
                   <div class="row">
                       <div class="col-12 grid-margin stretch-card">
                           <div class="card">
                               <div class="card-body">
                                   <form method="POST" id="form" action="<?= site_url(); ?>/usersave">
                                               ...
                                               <div class="col-5">
                                                   <div class="row">
                                                       <div class="col-12">
                                                           ...
                                                           <input type="text" name="user_name" class="form-control" id="user_name" value="<?= $selected ? $selected['user_name'] : '' ?>" required />
                                                       </div>
                                                   </div>
                                                   <div class="row">
                                                       <div class="col-12">
                                                           <label for="exampleInputName1">User ID:</label>
                                                           <input type="text" name="user_id" class="form-control" id="user_id" value="<?= $selected ? $selected['user_id'] : '' ?>" <?= $selected['id_update'] > 0 ? 'readonly' : 'required' ?> />
                                                       </div>
                                                   </div>
                                                   <div class="row">
                                                       <div class="col-12">
                                                           <label for="exampleInputName1">Password:</label>
                                                           <input type="password" name="pass" class="form-control" id="pass" value="<?= $selected ? $selected['password'] : '' ?>" <?= $selected['id_update'] > 0 ? 'readonly' : 'required' ?> />
                                                       </div>
                                                   </div>
                                                   <div class="row">
                                                       <div class="col-12">
                                                           <label for="exampleInputName1">Re-Enter Password:</label>
                                                           <input type="password" name="re_pass" class="form-control" id="re_pass" value="<?= $selected ? $selected['password'] : '' ?>" <?= $selected['id_update'] > 0 ? 'readonly' : 'required' ?> />
                                                       </div>
                                                   </div>
                                                   <div class="row">
                                                       <div class="col-12">
                                                           ...
                                                           <select class="form-control required" name="user_type" id="user_type">
                                                               ...
                                                               <option value="A" <?= $selected ? ($selected['user_type'] == 'A' ? 'selected' : '') : '' ?>>Admin</option>
                                                               <option value="U" <?= $selected ? ($selected['user_type'] == 'U' ? 'selected' : '') : '' ?>>User</option>
                                                           </select>
                                                       </div>
                                                   </div>
                                                   <div class="row">
                                                       <div class="col-12">
                                                           ...
                                                           <select class="form-control required" name="user_status" id="user_status">
                                                               <option value="">Select Type</option>
                                                               <option value="A" <?= $selected ? ($selected['user_status'] == 'A' ? 'selected' : '') : '' ?>>Active</option>
                                                               <option value="D" <?= $selected ? ($selected['user_status'] == 'D' ? 'selected' : '') : '' ?>>De-Active</option>
                                                           </select>
                                                       </div>
                                                   </div>
                                               </div>
                                       ...
                                       <input type="hidden" name="id_update" value="<?= $selected ? $selected['id_update'] : 0 ?>">
       ...
       <script>
           ...
           function check_submit() {
               var update = <?= $selected ? $selected['id_update'] : 0 ?>;
               if (update == 0) {
                   if (pass_chk) {
                       return true;
                   } else {
